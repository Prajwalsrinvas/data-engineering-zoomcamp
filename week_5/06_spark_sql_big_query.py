...
spark.conf.set("temporaryGcsBucket", "dataproc-temp-asia-south1-846679311535-8z9tortq")
...
"""
Running script using gcloud on Dataproc, to store results data in BigQuery:

gcloud dataproc jobs submit pyspark \
    --cluster=dez-cluster \
    --region=asia-south1 \
    --jars=gs://spark-lib/bigquery/spark-bigquery-latest_2.12.jar \
    gs://dez-gcs/code/06_spark_sql_big_query.py \
    -- \
        --input_green=gs://dez-gcs/pq/green/2021/*/ \
        --input_yellow=gs://dez-gcs/pq/yellow/2021/*/ \
